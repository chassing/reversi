...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Theme'
        db.create_table(u'main_theme', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=254)),
            ('description', self.gf('django.db.models.fields.CharField')(default='', max_length=254)),
            ...
            ('field', self.gf('django.db.models.fields.CharField')(max_length=254, blank=True)),
        ))
        db.send_create_signal(u'main', ['Theme'])

        # Deleting field 'ReversiUser.skin'
        db.delete_column(u'main_reversiuser', 'skin_id')

        # Adding field 'ReversiUser.theme'
        db.add_column(u'main_reversiuser', 'theme',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Theme'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'main_theme')

        # Adding field 'ReversiUser.skin'
        db.add_column(u'main_reversiuser', 'skin',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Skin'], null=True),
                      keep_default=False)

        # Deleting field 'ReversiUser.theme'
        db.delete_column(u'main_reversiuser', 'theme_id')
