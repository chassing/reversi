...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReversiUser.score'
        db.add_column(u'main_reversiuser', 'score',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ReversiUser.games_won'
        db.add_column(u'main_reversiuser', 'games_won',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ReversiUser.games_lost'
        db.add_column(u'main_reversiuser', 'games_lost',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ReversiUser.games_surrendered'
        db.add_column(u'main_reversiuser', 'games_surrendered',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReversiUser.score'
        db.delete_column(u'main_reversiuser', 'score')

        # Deleting field 'ReversiUser.games_won'
        db.delete_column(u'main_reversiuser', 'games_won')

        # Deleting field 'ReversiUser.games_lost'
        db.delete_column(u'main_reversiuser', 'games_lost')

        # Deleting field 'ReversiUser.games_surrendered'
        db.delete_column(u'main_reversiuser', 'games_surrendered')
    ...
    models = {
        ...
        u'main.reversiuser': {
            ...
            'games_lost': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'games_surrendered': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
