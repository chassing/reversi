...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'main_player', 'color', self.gf('django.db.models.fields.CharField')(max_length=1))
        # Adding field 'Game.name'
        db.add_column(u'main_game', 'name',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'main_game', 'name')
    ...
    models = {
        ...
        u'main.reversiuser': {
            ...
            'skin': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.Skin']", 'null': 'True'}),
