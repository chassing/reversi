...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Move.row'
        db.add_column(u'main_move', 'row',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Move.col'
        db.add_column(u'main_move', 'col',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Move.row'
        db.delete_column(u'main_move', 'row')

        # Deleting field 'Move.col'
        db.delete_column(u'main_move', 'col')
